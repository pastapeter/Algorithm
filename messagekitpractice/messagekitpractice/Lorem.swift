...
class Lorem {
     ...
     */
    internal class func word() -> String {
     ...
     */
    internal class func words(nbWords: Int = 3) -> [String] {
    ...
    /**
     ...
     - returns:
     */
    internal class func sentence(nbWords: Int = 6, variable: Bool = true) -> String {
        if nbWords <= 0 {
            return ""
        }
     ...
     */
    internal class func sentences(nbSentences: Int = 3) -> [String] {
     ...
     */
    internal class func paragraph(nbSentences: Int = 3, variable: Bool = true) -> String {
        if nbSentences <= 0 {
            return ""
        }
     ...
     */
    internal class func paragraphs(nbParagraphs: Int = 3) -> [String] {
     ...
     */
    internal class func text(maxNbChars: Int = 200) -> String {
        var result: [String] = []
...
extension Int {
     ...
     */
    internal static func random(min: Int = 0, max: Int = Int.max) -> Int {
    ...
    internal func randomize(variation: Int) -> Int {
