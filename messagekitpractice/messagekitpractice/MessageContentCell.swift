...
/// A subclass of `MessageCollectionViewCell` used to display text, media, and location messages.
 class MessageContentCell: MessageCollectionViewCell {
    ...
    /// - attributes: The `MessagesCollectionViewLayoutAttributes` for the cell.
     func layoutCellBottomLabel(with attributes: MessagesCollectionViewLayoutAttributes) {
    ...
    /// - attributes: The `MessagesCollectionViewLayoutAttributes` for the cell.
     func layoutMessageBottomLabel(with attributes: MessagesCollectionViewLayoutAttributes) {
    ...
    /// - attributes: The `MessagesCollectionViewLayoutAttributes` for the cell.
     func layoutTimeLabelView(with attributes: MessagesCollectionViewLayoutAttributes) {
